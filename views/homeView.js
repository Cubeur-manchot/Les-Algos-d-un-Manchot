	...
	getContent = () =>
		[
			...
			this.createNavTag({className: "cardList navigationCardList"},
				...
				this.createNavigationCard(true, "Records", "Records", "../images/logos/records.png", "/records"),
				this.createNavigationCard(true, "Collection", "Collection", "../images/logos/collection.png", "/collection"),
				...
				this.createNavigationCard(true, "Contact", "Contact", "../images/logos/avatar.png","/contact")
			)
		];
