...
function createHtmlTagWithClassNameHrefAndTextContent(tagType, tagClassName, tagHref, tagTextContent) // create simple HTML tag and set its class, href and text content
{
	let htmlTag = document.createElement(tagType);
	htmlTag.className = tagClassName;
...
function createHtmlTagWithIdClassNameHrefTextContent(tagType, tagId, tagClassName, tagHref, tagTextContent) // create simple HTML tag and set its class, id, href and text content
{
	let htmlTag = document.createElement(tagType);
	htmlTag.id = tagId;
	htmlTag.className = tagClassName;
